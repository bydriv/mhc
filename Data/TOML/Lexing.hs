...
semanticActions = SemanticActions
  ...
  , saNewline = withPosition $ \pos n _ -> return $ Just $ Parsing.NEWLINE (pos, n)
  ...
  , saLBracket = withPosition $ \pos n _ -> return $ Just $ Parsing.LBRACKET (pos, n)
  , saLBrace = withPosition $ \pos n _ -> return $ Just $ Parsing.LBRACE (pos, n)
  , saRBracket = withPosition $ \pos n _ -> return $ Just $ Parsing.RBRACKET (pos, n)
  , saRBrace = withPosition $ \pos n _ -> return $ Just $ Parsing.RBRACE (pos, n)
