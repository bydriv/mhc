...
dfaActionTransition q s =
  case (q, s) of
    ...
    (11, Token (MODULE _)) -> Just (Reduce 1 228)
    (11, Token (WHERE _)) -> Just (Reduce 1 228)
    (11, Token (RBRACE _)) -> Just (Reduce 1 228)
    (11, Token (LPAREN _)) -> Just (Reduce 1 228)
    (11, Token (RPAREN _)) -> Just (Reduce 1 228)
    (11, Token (COMMA _)) -> Just (Reduce 1 228)
    (11, Token (SEMICOLON _)) -> Just (Reduce 1 228)
    (11, Token (HIDING _)) -> Just (Reduce 1 228)
    (11, Token (MINUS _)) -> Just (Reduce 1 228)
    (11, Token (QCONID _)) -> Just (Reduce 1 228)
    (11, Token (EXPORT _)) -> Just (Reduce 1 228)
    (11, Token (AS _)) -> Just (Reduce 1 228)
    (11, Token (QVARID _)) -> Just (Reduce 1 228)
    (11, Token (QVARSYM _)) -> Just (Reduce 1 228)
    (11, Token (QCONSYM _)) -> Just (Reduce 1 228)
    ...
    (103, Token (WHERE _)) -> Just (Reduce 3 208)
    (103, Token (LBRACE _)) -> Just (Reduce 3 208)
    (103, Token (RBRACE _)) -> Just (Reduce 3 208)
    (103, Token (LPAREN _)) -> Just (Reduce 3 208)
    (103, Token (RPAREN _)) -> Just (Reduce 3 208)
    (103, Token (COMMA _)) -> Just (Reduce 3 208)
    (103, Token (SEMICOLON _)) -> Just (Reduce 3 208)
    (103, Token (EQUAL _)) -> Just (Reduce 3 208)
    (103, Token (PIPE _)) -> Just (Reduce 3 208)
    (103, Token (COLON_COLON _)) -> Just (Reduce 3 208)
    (103, Token (MINUS _)) -> Just (Reduce 3 208)
    (103, Token (INFIXL _)) -> Just (Reduce 3 208)
    (103, Token (INFIXR _)) -> Just (Reduce 3 208)
    (103, Token (INFIX _)) -> Just (Reduce 3 208)
    (103, Token (RARROW _)) -> Just (Reduce 3 208)
    (103, Token (QCONID _)) -> Just (Reduce 3 208)
    (103, Token (EXPORT _)) -> Just (Reduce 3 208)
    (103, Token (AS _)) -> Just (Reduce 3 208)
    (103, Token (QVARID _)) -> Just (Reduce 3 208)
    (103, Token (STRING _)) -> Just (Reduce 3 208)
    (103, Token (LARROW _)) -> Just (Reduce 3 208)
    (103, Token (LET _)) -> Just (Reduce 3 208)
    (103, Token (LAMBDA _)) -> Just (Reduce 3 208)
    (103, Token (IF _)) -> Just (Reduce 3 208)
    (103, Token (THEN _)) -> Just (Reduce 3 208)
    (103, Token (ELSE _)) -> Just (Reduce 3 208)
    (103, Token (QVARSYM _)) -> Just (Reduce 3 208)
    (103, Token (BACKQUOTE _)) -> Just (Reduce 3 208)
    (103, Token (QCONSYM _)) -> Just (Reduce 3 208)
    (103, Token (CASE _)) -> Just (Reduce 3 208)
    (103, Token (OF _)) -> Just (Reduce 3 208)
    (103, Token (DO _)) -> Just (Reduce 3 208)
    (103, Token (INTEGER _)) -> Just (Reduce 3 208)
    (104, Token (WHERE _)) -> Just (Reduce 3 209)
    (104, Token (LBRACE _)) -> Just (Reduce 3 209)
    (104, Token (RBRACE _)) -> Just (Reduce 3 209)
    (104, Token (LPAREN _)) -> Just (Reduce 3 209)
    (104, Token (RPAREN _)) -> Just (Reduce 3 209)
    (104, Token (COMMA _)) -> Just (Reduce 3 209)
    (104, Token (SEMICOLON _)) -> Just (Reduce 3 209)
    (104, Token (EQUAL _)) -> Just (Reduce 3 209)
    (104, Token (PIPE _)) -> Just (Reduce 3 209)
    (104, Token (COLON_COLON _)) -> Just (Reduce 3 209)
    (104, Token (MINUS _)) -> Just (Reduce 3 209)
    (104, Token (INFIXL _)) -> Just (Reduce 3 209)
    (104, Token (INFIXR _)) -> Just (Reduce 3 209)
    (104, Token (INFIX _)) -> Just (Reduce 3 209)
    (104, Token (RARROW _)) -> Just (Reduce 3 209)
    (104, Token (QCONID _)) -> Just (Reduce 3 209)
    (104, Token (EXPORT _)) -> Just (Reduce 3 209)
    (104, Token (AS _)) -> Just (Reduce 3 209)
    (104, Token (QVARID _)) -> Just (Reduce 3 209)
    (104, Token (STRING _)) -> Just (Reduce 3 209)
    (104, Token (LARROW _)) -> Just (Reduce 3 209)
    (104, Token (LET _)) -> Just (Reduce 3 209)
    (104, Token (LAMBDA _)) -> Just (Reduce 3 209)
    (104, Token (IF _)) -> Just (Reduce 3 209)
    (104, Token (THEN _)) -> Just (Reduce 3 209)
    (104, Token (ELSE _)) -> Just (Reduce 3 209)
    (104, Token (QVARSYM _)) -> Just (Reduce 3 209)
    (104, Token (BACKQUOTE _)) -> Just (Reduce 3 209)
    (104, Token (QCONSYM _)) -> Just (Reduce 3 209)
    (104, Token (CASE _)) -> Just (Reduce 3 209)
    (104, Token (OF _)) -> Just (Reduce 3 209)
    (104, Token (DO _)) -> Just (Reduce 3 209)
    (104, Token (INTEGER _)) -> Just (Reduce 3 209)
    (105, Token (RPAREN _)) -> Just (Shift 103)
    (106, Token (WHERE _)) -> Just (Reduce 1 206)
    (106, Token (LBRACE _)) -> Just (Reduce 1 206)
    (106, Token (RBRACE _)) -> Just (Reduce 1 206)
    (106, Token (LPAREN _)) -> Just (Reduce 1 206)
    (106, Token (RPAREN _)) -> Just (Reduce 1 206)
    (106, Token (COMMA _)) -> Just (Reduce 1 206)
    (106, Token (SEMICOLON _)) -> Just (Reduce 1 206)
    (106, Token (EQUAL _)) -> Just (Reduce 1 206)
    (106, Token (PIPE _)) -> Just (Reduce 1 206)
    (106, Token (COLON_COLON _)) -> Just (Reduce 1 206)
    (106, Token (MINUS _)) -> Just (Reduce 1 206)
    (106, Token (INFIXL _)) -> Just (Reduce 1 206)
    (106, Token (INFIXR _)) -> Just (Reduce 1 206)
    (106, Token (INFIX _)) -> Just (Reduce 1 206)
    (106, Token (RARROW _)) -> Just (Reduce 1 206)
    (106, Token (QCONID _)) -> Just (Reduce 1 206)
    (106, Token (EXPORT _)) -> Just (Reduce 1 206)
    (106, Token (AS _)) -> Just (Reduce 1 206)
    (106, Token (QVARID _)) -> Just (Reduce 1 206)
    (106, Token (STRING _)) -> Just (Reduce 1 206)
    (106, Token (LARROW _)) -> Just (Reduce 1 206)
    (106, Token (LET _)) -> Just (Reduce 1 206)
    (106, Token (LAMBDA _)) -> Just (Reduce 1 206)
    (106, Token (IF _)) -> Just (Reduce 1 206)
    (106, Token (THEN _)) -> Just (Reduce 1 206)
    (106, Token (ELSE _)) -> Just (Reduce 1 206)
    (106, Token (QVARSYM _)) -> Just (Reduce 1 206)
    (106, Token (BACKQUOTE _)) -> Just (Reduce 1 206)
    (106, Token (QCONSYM _)) -> Just (Reduce 1 206)
    (106, Token (CASE _)) -> Just (Reduce 1 206)
    (106, Token (OF _)) -> Just (Reduce 1 206)
    (106, Token (DO _)) -> Just (Reduce 1 206)
    (106, Token (INTEGER _)) -> Just (Reduce 1 206)
    (107, Token (WHERE _)) -> Just (Reduce 1 205)
    (107, Token (LBRACE _)) -> Just (Reduce 1 205)
    (107, Token (RBRACE _)) -> Just (Reduce 1 205)
    (107, Token (LPAREN _)) -> Just (Reduce 1 205)
    (107, Token (RPAREN _)) -> Just (Reduce 1 205)
    (107, Token (COMMA _)) -> Just (Reduce 1 205)
    (107, Token (SEMICOLON _)) -> Just (Reduce 1 205)
    (107, Token (EQUAL _)) -> Just (Reduce 1 205)
    (107, Token (PIPE _)) -> Just (Reduce 1 205)
    (107, Token (COLON_COLON _)) -> Just (Reduce 1 205)
    (107, Token (MINUS _)) -> Just (Reduce 1 205)
    (107, Token (INFIXL _)) -> Just (Reduce 1 205)
    (107, Token (INFIXR _)) -> Just (Reduce 1 205)
    (107, Token (INFIX _)) -> Just (Reduce 1 205)
    (107, Token (RARROW _)) -> Just (Reduce 1 205)
    (107, Token (QCONID _)) -> Just (Reduce 1 205)
    (107, Token (EXPORT _)) -> Just (Reduce 1 205)
    (107, Token (AS _)) -> Just (Reduce 1 205)
    (107, Token (QVARID _)) -> Just (Reduce 1 205)
    (107, Token (STRING _)) -> Just (Reduce 1 205)
    (107, Token (LARROW _)) -> Just (Reduce 1 205)
    (107, Token (LET _)) -> Just (Reduce 1 205)
    (107, Token (LAMBDA _)) -> Just (Reduce 1 205)
    (107, Token (IF _)) -> Just (Reduce 1 205)
    (107, Token (THEN _)) -> Just (Reduce 1 205)
    (107, Token (ELSE _)) -> Just (Reduce 1 205)
    (107, Token (QVARSYM _)) -> Just (Reduce 1 205)
    (107, Token (BACKQUOTE _)) -> Just (Reduce 1 205)
    (107, Token (QCONSYM _)) -> Just (Reduce 1 205)
    (107, Token (CASE _)) -> Just (Reduce 1 205)
    (107, Token (OF _)) -> Just (Reduce 1 205)
    (107, Token (DO _)) -> Just (Reduce 1 205)
    (107, Token (INTEGER _)) -> Just (Reduce 1 205)
    (108, Token (WHERE _)) -> Just (Reduce 1 207)
    (108, Token (LBRACE _)) -> Just (Reduce 1 207)
    (108, Token (RBRACE _)) -> Just (Reduce 1 207)
    (108, Token (LPAREN _)) -> Just (Reduce 1 207)
    (108, Token (RPAREN _)) -> Just (Reduce 1 207)
    (108, Token (COMMA _)) -> Just (Reduce 1 207)
    (108, Token (SEMICOLON _)) -> Just (Reduce 1 207)
    (108, Token (EQUAL _)) -> Just (Reduce 1 207)
    (108, Token (PIPE _)) -> Just (Reduce 1 207)
    (108, Token (COLON_COLON _)) -> Just (Reduce 1 207)
    (108, Token (MINUS _)) -> Just (Reduce 1 207)
    (108, Token (INFIXL _)) -> Just (Reduce 1 207)
    (108, Token (INFIXR _)) -> Just (Reduce 1 207)
    (108, Token (INFIX _)) -> Just (Reduce 1 207)
    (108, Token (RARROW _)) -> Just (Reduce 1 207)
    (108, Token (QCONID _)) -> Just (Reduce 1 207)
    (108, Token (EXPORT _)) -> Just (Reduce 1 207)
    (108, Token (AS _)) -> Just (Reduce 1 207)
    (108, Token (QVARID _)) -> Just (Reduce 1 207)
    (108, Token (STRING _)) -> Just (Reduce 1 207)
    (108, Token (LARROW _)) -> Just (Reduce 1 207)
    (108, Token (LET _)) -> Just (Reduce 1 207)
    (108, Token (LAMBDA _)) -> Just (Reduce 1 207)
    (108, Token (IF _)) -> Just (Reduce 1 207)
    (108, Token (THEN _)) -> Just (Reduce 1 207)
    (108, Token (ELSE _)) -> Just (Reduce 1 207)
    (108, Token (QVARSYM _)) -> Just (Reduce 1 207)
    (108, Token (BACKQUOTE _)) -> Just (Reduce 1 207)
    (108, Token (QCONSYM _)) -> Just (Reduce 1 207)
    (108, Token (CASE _)) -> Just (Reduce 1 207)
    (108, Token (OF _)) -> Just (Reduce 1 207)
    (108, Token (DO _)) -> Just (Reduce 1 207)
    (108, Token (INTEGER _)) -> Just (Reduce 1 207)
    ...
    (156, Token (WHERE _)) -> Just (Reduce 3 211)
    (156, Token (LBRACE _)) -> Just (Reduce 3 211)
    (156, Token (RBRACE _)) -> Just (Reduce 3 211)
    (156, Token (LPAREN _)) -> Just (Reduce 3 211)
    (156, Token (RPAREN _)) -> Just (Reduce 3 211)
    (156, Token (COMMA _)) -> Just (Reduce 3 211)
    (156, Token (SEMICOLON _)) -> Just (Reduce 3 211)
    (156, Token (EQUAL _)) -> Just (Reduce 3 211)
    (156, Token (DERIVING _)) -> Just (Reduce 3 211)
    (156, Token (DARROW _)) -> Just (Reduce 3 211)
    (156, Token (PIPE _)) -> Just (Reduce 3 211)
    (156, Token (COLON_COLON _)) -> Just (Reduce 3 211)
    (156, Token (MINUS _)) -> Just (Reduce 3 211)
    (156, Token (INFIXL _)) -> Just (Reduce 3 211)
    (156, Token (INFIXR _)) -> Just (Reduce 3 211)
    (156, Token (INFIX _)) -> Just (Reduce 3 211)
    (156, Token (RARROW _)) -> Just (Reduce 3 211)
    (156, Token (LBRACKET _)) -> Just (Reduce 3 211)
    (156, Token (RBRACKET _)) -> Just (Reduce 3 211)
    (156, Token (EXCL _)) -> Just (Reduce 3 211)
    (156, Token (QCONID _)) -> Just (Reduce 3 211)
    (156, Token (EXPORT _)) -> Just (Reduce 3 211)
    (156, Token (AS _)) -> Just (Reduce 3 211)
    (156, Token (QVARID _)) -> Just (Reduce 3 211)
    (156, Token (LARROW _)) -> Just (Reduce 3 211)
    (156, Token (THEN _)) -> Just (Reduce 3 211)
    (156, Token (ELSE _)) -> Just (Reduce 3 211)
    (156, Token (QVARSYM _)) -> Just (Reduce 3 211)
    (156, Token (BACKQUOTE _)) -> Just (Reduce 3 211)
    (156, Token (QCONSYM _)) -> Just (Reduce 3 211)
    (156, Token (OF _)) -> Just (Reduce 3 211)
    (156, Token (INTEGER _)) -> Just (Reduce 3 211)
    (157, Token (WHERE _)) -> Just (Reduce 1 210)
    (157, Token (LBRACE _)) -> Just (Reduce 1 210)
    (157, Token (RBRACE _)) -> Just (Reduce 1 210)
    (157, Token (LPAREN _)) -> Just (Reduce 1 210)
    (157, Token (RPAREN _)) -> Just (Reduce 1 210)
    (157, Token (COMMA _)) -> Just (Reduce 1 210)
    (157, Token (SEMICOLON _)) -> Just (Reduce 1 210)
    (157, Token (EQUAL _)) -> Just (Reduce 1 210)
    (157, Token (DERIVING _)) -> Just (Reduce 1 210)
    (157, Token (DARROW _)) -> Just (Reduce 1 210)
    (157, Token (PIPE _)) -> Just (Reduce 1 210)
    (157, Token (COLON_COLON _)) -> Just (Reduce 1 210)
    (157, Token (MINUS _)) -> Just (Reduce 1 210)
    (157, Token (INFIXL _)) -> Just (Reduce 1 210)
    (157, Token (INFIXR _)) -> Just (Reduce 1 210)
    (157, Token (INFIX _)) -> Just (Reduce 1 210)
    (157, Token (RARROW _)) -> Just (Reduce 1 210)
    (157, Token (LBRACKET _)) -> Just (Reduce 1 210)
    (157, Token (RBRACKET _)) -> Just (Reduce 1 210)
    (157, Token (EXCL _)) -> Just (Reduce 1 210)
    (157, Token (QCONID _)) -> Just (Reduce 1 210)
    (157, Token (EXPORT _)) -> Just (Reduce 1 210)
    (157, Token (AS _)) -> Just (Reduce 1 210)
    (157, Token (QVARID _)) -> Just (Reduce 1 210)
    (157, Token (LARROW _)) -> Just (Reduce 1 210)
    (157, Token (THEN _)) -> Just (Reduce 1 210)
    (157, Token (ELSE _)) -> Just (Reduce 1 210)
    (157, Token (QVARSYM _)) -> Just (Reduce 1 210)
    (157, Token (BACKQUOTE _)) -> Just (Reduce 1 210)
    (157, Token (QCONSYM _)) -> Just (Reduce 1 210)
    (157, Token (OF _)) -> Just (Reduce 1 210)
    (157, Token (INTEGER _)) -> Just (Reduce 1 210)
    ...
    (188, Token (QCONID _)) -> Just (Reduce 0 222)
    ...
    (196, Token (RBRACE _)) -> Just (Reduce 0 220)
    (196, Token (LPAREN _)) -> Just (Reduce 0 220)
    (196, Token (SEMICOLON _)) -> Just (Reduce 0 220)
    (196, Token (HIDING _)) -> Just (Reduce 0 220)
    ...
    (220, Token (QCONID _)) -> Just (Reduce 1 223)
    (221, Token (RBRACE _)) -> Just (Reduce 2 221)
    (221, Token (LPAREN _)) -> Just (Reduce 2 221)
    (221, Token (SEMICOLON _)) -> Just (Reduce 2 221)
    (221, Token (HIDING _)) -> Just (Reduce 2 221)
    ...
    (273, Token (COMMA _)) -> Just (Reduce 0 229)
    (273, Token (MINUS _)) -> Just (Reduce 0 229)
    (273, Token (QCONID _)) -> Just (Reduce 0 229)
    (273, Token (EXPORT _)) -> Just (Reduce 0 229)
    (273, Token (AS _)) -> Just (Reduce 0 229)
    (273, Token (QVARID _)) -> Just (Reduce 0 229)
    (273, Token (QVARSYM _)) -> Just (Reduce 0 229)
    (273, Token (BACKQUOTE _)) -> Just (Reduce 0 229)
    (273, Token (QCONSYM _)) -> Just (Reduce 0 229)
    ...
    (276, Token (LPAREN _)) -> Just (Reduce 1 199)
    (276, Token (RPAREN _)) -> Just (Reduce 1 199)
    (276, Token (EQUAL _)) -> Just (Reduce 1 199)
    (276, Token (PIPE _)) -> Just (Reduce 1 199)
    (276, Token (MINUS _)) -> Just (Reduce 1 199)
    (276, Token (RARROW _)) -> Just (Reduce 1 199)
    (276, Token (QCONID _)) -> Just (Reduce 1 199)
    (276, Token (EXPORT _)) -> Just (Reduce 1 199)
    (276, Token (AS _)) -> Just (Reduce 1 199)
    (276, Token (QVARID _)) -> Just (Reduce 1 199)
    (276, Token (QVARSYM _)) -> Just (Reduce 1 199)
    (276, Token (BACKQUOTE _)) -> Just (Reduce 1 199)
    (276, Token (QCONSYM _)) -> Just (Reduce 1 199)
    (277, Token (LPAREN _)) -> Just (Reduce 3 201)
    (277, Token (RPAREN _)) -> Just (Reduce 3 201)
    (277, Token (EQUAL _)) -> Just (Reduce 3 201)
    (277, Token (PIPE _)) -> Just (Reduce 3 201)
    (277, Token (MINUS _)) -> Just (Reduce 3 201)
    (277, Token (RARROW _)) -> Just (Reduce 3 201)
    (277, Token (QCONID _)) -> Just (Reduce 3 201)
    (277, Token (EXPORT _)) -> Just (Reduce 3 201)
    (277, Token (AS _)) -> Just (Reduce 3 201)
    (277, Token (QVARID _)) -> Just (Reduce 3 201)
    (277, Token (QVARSYM _)) -> Just (Reduce 3 201)
    (277, Token (BACKQUOTE _)) -> Just (Reduce 3 201)
    (277, Token (QCONSYM _)) -> Just (Reduce 3 201)
    (278, Token (LPAREN _)) -> Just (Reduce 2 200)
    (278, Token (RPAREN _)) -> Just (Reduce 2 200)
    (278, Token (EQUAL _)) -> Just (Reduce 2 200)
    (278, Token (PIPE _)) -> Just (Reduce 2 200)
    (278, Token (MINUS _)) -> Just (Reduce 2 200)
    (278, Token (RARROW _)) -> Just (Reduce 2 200)
    (278, Token (QCONID _)) -> Just (Reduce 2 200)
    (278, Token (EXPORT _)) -> Just (Reduce 2 200)
    (278, Token (AS _)) -> Just (Reduce 2 200)
    (278, Token (QVARID _)) -> Just (Reduce 2 200)
    (278, Token (QVARSYM _)) -> Just (Reduce 2 200)
    (278, Token (BACKQUOTE _)) -> Just (Reduce 2 200)
    (278, Token (QCONSYM _)) -> Just (Reduce 2 200)
    (279, Token (LPAREN _)) -> Just (Reduce 3 202)
    (279, Token (RPAREN _)) -> Just (Reduce 3 202)
    (279, Token (EQUAL _)) -> Just (Reduce 3 202)
    (279, Token (PIPE _)) -> Just (Reduce 3 202)
    (279, Token (MINUS _)) -> Just (Reduce 3 202)
    (279, Token (RARROW _)) -> Just (Reduce 3 202)
    (279, Token (QCONID _)) -> Just (Reduce 3 202)
    (279, Token (EXPORT _)) -> Just (Reduce 3 202)
    (279, Token (AS _)) -> Just (Reduce 3 202)
    (279, Token (QVARID _)) -> Just (Reduce 3 202)
    (279, Token (QVARSYM _)) -> Just (Reduce 3 202)
    (279, Token (BACKQUOTE _)) -> Just (Reduce 3 202)
    (279, Token (QCONSYM _)) -> Just (Reduce 3 202)
    ...
    (302, Token (LPAREN _)) -> Just (Reduce 1 203)
    (302, Token (COMMA _)) -> Just (Shift 94)
    (302, Token (EQUAL _)) -> Just (Reduce 1 203)
    (302, Token (PIPE _)) -> Just (Reduce 1 203)
    (302, Token (COLON_COLON _)) -> Just (Reduce 1 93)
    (302, Token (MINUS _)) -> Just (Reduce 1 203)
    (302, Token (QCONID _)) -> Just (Reduce 1 203)
    (302, Token (EXPORT _)) -> Just (Reduce 1 203)
    (302, Token (AS _)) -> Just (Reduce 1 203)
    (302, Token (QVARID _)) -> Just (Reduce 1 203)
    (302, Token (QVARSYM _)) -> Just (Reduce 1 203)
    (302, Token (BACKQUOTE _)) -> Just (Reduce 1 203)
    (302, Token (QCONSYM _)) -> Just (Reduce 1 203)
    ...
    (307, Token (COMMA _)) -> Just (Reduce 1 230)
    (307, Token (MINUS _)) -> Just (Reduce 1 230)
    (307, Token (QCONID _)) -> Just (Reduce 1 230)
    (307, Token (EXPORT _)) -> Just (Reduce 1 230)
    (307, Token (AS _)) -> Just (Reduce 1 230)
    (307, Token (QVARID _)) -> Just (Reduce 1 230)
    (307, Token (QVARSYM _)) -> Just (Reduce 1 230)
    (307, Token (BACKQUOTE _)) -> Just (Reduce 1 230)
    (307, Token (QCONSYM _)) -> Just (Reduce 1 230)
    ...
    (314, Token (RBRACE _)) -> Just (Reduce 1 219)
    (314, Token (LPAREN _)) -> Just (Reduce 1 219)
    (314, Token (COMMA _)) -> Just (Reduce 1 219)
    (314, Token (SEMICOLON _)) -> Just (Reduce 1 219)
    (314, Token (MINUS _)) -> Just (Reduce 1 219)
    (314, Token (QCONID _)) -> Just (Reduce 1 219)
    (314, Token (EXPORT _)) -> Just (Reduce 1 219)
    (314, Token (AS _)) -> Just (Reduce 1 219)
    (314, Token (QVARID _)) -> Just (Reduce 1 219)
    (314, Token (QVARSYM _)) -> Just (Reduce 1 219)
    (314, Token (BACKQUOTE _)) -> Just (Reduce 1 219)
    (314, Token (QCONSYM _)) -> Just (Reduce 1 219)
    (315, Token (RBRACE _)) -> Just (Reduce 1 218)
    (315, Token (LPAREN _)) -> Just (Reduce 1 218)
    (315, Token (COMMA _)) -> Just (Reduce 1 218)
    (315, Token (SEMICOLON _)) -> Just (Reduce 1 218)
    (315, Token (MINUS _)) -> Just (Reduce 1 218)
    (315, Token (QCONID _)) -> Just (Reduce 1 218)
    (315, Token (EXPORT _)) -> Just (Reduce 1 218)
    (315, Token (AS _)) -> Just (Reduce 1 218)
    (315, Token (QVARID _)) -> Just (Reduce 1 218)
    (315, Token (QVARSYM _)) -> Just (Reduce 1 218)
    (315, Token (BACKQUOTE _)) -> Just (Reduce 1 218)
    (315, Token (QCONSYM _)) -> Just (Reduce 1 218)
    ...
    (333, Token (WHERE _)) -> Just (Reduce 1 225)
    (333, Token (LBRACE _)) -> Just (Reduce 1 225)
    (333, Token (RBRACE _)) -> Just (Reduce 1 225)
    (333, Token (LPAREN _)) -> Just (Reduce 1 225)
    (333, Token (RPAREN _)) -> Just (Reduce 1 225)
    (333, Token (COMMA _)) -> Just (Reduce 1 225)
    (333, Token (SEMICOLON _)) -> Just (Reduce 1 225)
    (333, Token (EQUAL _)) -> Just (Reduce 1 225)
    (333, Token (DERIVING _)) -> Just (Reduce 1 225)
    (333, Token (DARROW _)) -> Just (Reduce 1 225)
    (333, Token (PIPE _)) -> Just (Reduce 1 225)
    (333, Token (COLON_COLON _)) -> Just (Reduce 1 225)
    (333, Token (MINUS _)) -> Just (Reduce 1 225)
    (333, Token (INFIXL _)) -> Just (Reduce 1 225)
    (333, Token (INFIXR _)) -> Just (Reduce 1 225)
    (333, Token (INFIX _)) -> Just (Reduce 1 225)
    (333, Token (RARROW _)) -> Just (Reduce 1 225)
    (333, Token (LBRACKET _)) -> Just (Reduce 1 225)
    (333, Token (RBRACKET _)) -> Just (Reduce 1 225)
    (333, Token (EXCL _)) -> Just (Reduce 1 225)
    (333, Token (QCONID _)) -> Just (Reduce 1 225)
    (333, Token (EXPORT _)) -> Just (Reduce 1 225)
    (333, Token (AS _)) -> Just (Reduce 1 225)
    (333, Token (QVARID _)) -> Just (Reduce 1 225)
    (333, Token (LARROW _)) -> Just (Reduce 1 225)
    (333, Token (THEN _)) -> Just (Reduce 1 225)
    (333, Token (ELSE _)) -> Just (Reduce 1 225)
    (333, Token (QVARSYM _)) -> Just (Reduce 1 225)
    (333, Token (BACKQUOTE _)) -> Just (Reduce 1 225)
    (333, Token (QCONSYM _)) -> Just (Reduce 1 225)
    (333, Token (OF _)) -> Just (Reduce 1 225)
    (333, Token (INTEGER _)) -> Just (Reduce 1 225)
    (334, Token (WHERE _)) -> Just (Reduce 1 224)
    (334, Token (LBRACE _)) -> Just (Reduce 1 224)
    (334, Token (RBRACE _)) -> Just (Reduce 1 224)
    (334, Token (LPAREN _)) -> Just (Reduce 1 224)
    (334, Token (RPAREN _)) -> Just (Reduce 1 224)
    (334, Token (COMMA _)) -> Just (Reduce 1 224)
    (334, Token (SEMICOLON _)) -> Just (Reduce 1 224)
    (334, Token (EQUAL _)) -> Just (Reduce 1 224)
    (334, Token (DERIVING _)) -> Just (Reduce 1 224)
    (334, Token (DARROW _)) -> Just (Reduce 1 224)
    (334, Token (PIPE _)) -> Just (Reduce 1 224)
    (334, Token (COLON_COLON _)) -> Just (Reduce 1 224)
    (334, Token (MINUS _)) -> Just (Reduce 1 224)
    (334, Token (INFIXL _)) -> Just (Reduce 1 224)
    (334, Token (INFIXR _)) -> Just (Reduce 1 224)
    (334, Token (INFIX _)) -> Just (Reduce 1 224)
    (334, Token (RARROW _)) -> Just (Reduce 1 224)
    (334, Token (LBRACKET _)) -> Just (Reduce 1 224)
    (334, Token (RBRACKET _)) -> Just (Reduce 1 224)
    (334, Token (EXCL _)) -> Just (Reduce 1 224)
    (334, Token (QCONID _)) -> Just (Reduce 1 224)
    (334, Token (EXPORT _)) -> Just (Reduce 1 224)
    (334, Token (AS _)) -> Just (Reduce 1 224)
    (334, Token (QVARID _)) -> Just (Reduce 1 224)
    (334, Token (LARROW _)) -> Just (Reduce 1 224)
    (334, Token (THEN _)) -> Just (Reduce 1 224)
    (334, Token (ELSE _)) -> Just (Reduce 1 224)
    (334, Token (QVARSYM _)) -> Just (Reduce 1 224)
    (334, Token (BACKQUOTE _)) -> Just (Reduce 1 224)
    (334, Token (QCONSYM _)) -> Just (Reduce 1 224)
    (334, Token (OF _)) -> Just (Reduce 1 224)
    (334, Token (INTEGER _)) -> Just (Reduce 1 224)
    (335, Token (WHERE _)) -> Just (Reduce 1 226)
    (335, Token (LBRACE _)) -> Just (Reduce 1 226)
    (335, Token (RBRACE _)) -> Just (Reduce 1 226)
    (335, Token (LPAREN _)) -> Just (Reduce 1 226)
    (335, Token (RPAREN _)) -> Just (Reduce 1 226)
    (335, Token (COMMA _)) -> Just (Reduce 1 226)
    (335, Token (SEMICOLON _)) -> Just (Reduce 1 226)
    (335, Token (EQUAL _)) -> Just (Reduce 1 226)
    (335, Token (DERIVING _)) -> Just (Reduce 1 226)
    (335, Token (DARROW _)) -> Just (Reduce 1 226)
    (335, Token (PIPE _)) -> Just (Reduce 1 226)
    (335, Token (COLON_COLON _)) -> Just (Reduce 1 226)
    (335, Token (MINUS _)) -> Just (Reduce 1 226)
    (335, Token (INFIXL _)) -> Just (Reduce 1 226)
    (335, Token (INFIXR _)) -> Just (Reduce 1 226)
    (335, Token (INFIX _)) -> Just (Reduce 1 226)
    (335, Token (RARROW _)) -> Just (Reduce 1 226)
    (335, Token (LBRACKET _)) -> Just (Reduce 1 226)
    (335, Token (RBRACKET _)) -> Just (Reduce 1 226)
    (335, Token (EXCL _)) -> Just (Reduce 1 226)
    (335, Token (QCONID _)) -> Just (Reduce 1 226)
    (335, Token (EXPORT _)) -> Just (Reduce 1 226)
    (335, Token (AS _)) -> Just (Reduce 1 226)
    (335, Token (QVARID _)) -> Just (Reduce 1 226)
    (335, Token (LARROW _)) -> Just (Reduce 1 226)
    (335, Token (THEN _)) -> Just (Reduce 1 226)
    (335, Token (ELSE _)) -> Just (Reduce 1 226)
    (335, Token (QVARSYM _)) -> Just (Reduce 1 226)
    (335, Token (BACKQUOTE _)) -> Just (Reduce 1 226)
    (335, Token (QCONSYM _)) -> Just (Reduce 1 226)
    (335, Token (OF _)) -> Just (Reduce 1 226)
    (335, Token (INTEGER _)) -> Just (Reduce 1 226)
    ...
    (348, Token (RBRACE _)) -> Just (Reduce 3 217)
    (348, Token (LPAREN _)) -> Just (Reduce 3 217)
    (348, Token (RPAREN _)) -> Just (Reduce 3 217)
    (348, Token (COMMA _)) -> Just (Reduce 3 217)
    (348, Token (SEMICOLON _)) -> Just (Reduce 3 217)
    (348, Token (MINUS _)) -> Just (Reduce 3 217)
    (348, Token (RARROW _)) -> Just (Reduce 3 217)
    (348, Token (LBRACKET _)) -> Just (Reduce 3 217)
    (348, Token (RBRACKET _)) -> Just (Reduce 3 217)
    (348, Token (EXCL _)) -> Just (Reduce 3 217)
    (348, Token (QCONID _)) -> Just (Reduce 3 217)
    (348, Token (EXPORT _)) -> Just (Reduce 3 217)
    (348, Token (AS _)) -> Just (Reduce 3 217)
    (348, Token (QVARID _)) -> Just (Reduce 3 217)
    (348, Token (QVARSYM _)) -> Just (Reduce 3 217)
    (348, Token (BACKQUOTE _)) -> Just (Reduce 3 217)
    (348, Token (QCONSYM _)) -> Just (Reduce 3 217)
    (349, Token (RBRACE _)) -> Just (Reduce 1 216)
    (349, Token (LPAREN _)) -> Just (Reduce 1 216)
    (349, Token (RPAREN _)) -> Just (Reduce 1 216)
    (349, Token (COMMA _)) -> Just (Reduce 1 216)
    (349, Token (SEMICOLON _)) -> Just (Reduce 1 216)
    (349, Token (MINUS _)) -> Just (Reduce 1 216)
    (349, Token (RARROW _)) -> Just (Reduce 1 216)
    (349, Token (LBRACKET _)) -> Just (Reduce 1 216)
    (349, Token (RBRACKET _)) -> Just (Reduce 1 216)
    (349, Token (EXCL _)) -> Just (Reduce 1 216)
    (349, Token (QCONID _)) -> Just (Reduce 1 216)
    (349, Token (EXPORT _)) -> Just (Reduce 1 216)
    (349, Token (AS _)) -> Just (Reduce 1 216)
    (349, Token (QVARID _)) -> Just (Reduce 1 216)
    (349, Token (QVARSYM _)) -> Just (Reduce 1 216)
    (349, Token (BACKQUOTE _)) -> Just (Reduce 1 216)
    (349, Token (QCONSYM _)) -> Just (Reduce 1 216)
    ...
    (375, Token (RBRACE _)) -> Just (Reduce 2 198)
    (375, Token (SEMICOLON _)) -> Just (Reduce 2 198)
    ...
    (379, Token (THEN _)) -> Just (Reduce 0 231)
    (380, Token (SEMICOLON _)) -> Just (Shift 391)
    (380, Token (ELSE _)) -> Just (Reduce 0 231)
    ...
    (391, Token (THEN _)) -> Just (Reduce 1 232)
    (391, Token (ELSE _)) -> Just (Reduce 1 232)
    ...
    (402, Token (RBRACE _)) -> Just (Reduce 3 195)
    (403, Token (RBRACE _)) -> Just (Reduce 1 194)
    ...
    (428, Token (RBRACE _)) -> Just (Reduce 5 186)
    (428, Token (SEMICOLON _)) -> Just (Reduce 5 186)
    (429, Token (WHERE _)) -> Just (Shift 263)
    (429, Token (RBRACE _)) -> Just (Reduce 3 185)
    (429, Token (SEMICOLON _)) -> Just (Reduce 3 185)
    (430, Token (RBRACE _)) -> Just (Reduce 1 196)
    (430, Token (SEMICOLON _)) -> Just (Reduce 1 196)
    (430, Token (LARROW _)) -> Just (Shift 53)
    (431, Token (RBRACE _)) -> Just (Reduce 3 197)
    (431, Token (SEMICOLON _)) -> Just (Reduce 3 197)
    (432, Token (LPAREN _)) -> Just (Reduce 3 204)
    (432, Token (RPAREN _)) -> Just (Reduce 3 204)
    (432, Token (EQUAL _)) -> Just (Reduce 3 204)
    (432, Token (PIPE _)) -> Just (Reduce 3 204)
    (432, Token (MINUS _)) -> Just (Reduce 3 204)
    (432, Token (RARROW _)) -> Just (Reduce 3 204)
    (432, Token (QCONID _)) -> Just (Reduce 3 204)
    (432, Token (EXPORT _)) -> Just (Reduce 3 204)
    (432, Token (AS _)) -> Just (Reduce 3 204)
    (432, Token (QVARID _)) -> Just (Reduce 3 204)
    (432, Token (QVARSYM _)) -> Just (Reduce 3 204)
    (432, Token (BACKQUOTE _)) -> Just (Reduce 3 204)
    (432, Token (QCONSYM _)) -> Just (Reduce 3 204)
    (433, Token (LPAREN _)) -> Just (Reduce 1 203)
    (433, Token (RPAREN _)) -> Just (Reduce 1 203)
    (433, Token (EQUAL _)) -> Just (Reduce 1 203)
    (433, Token (PIPE _)) -> Just (Reduce 1 203)
    (433, Token (MINUS _)) -> Just (Reduce 1 203)
    (433, Token (RARROW _)) -> Just (Reduce 1 203)
    (433, Token (QCONID _)) -> Just (Reduce 1 203)
    (433, Token (EXPORT _)) -> Just (Reduce 1 203)
    (433, Token (AS _)) -> Just (Reduce 1 203)
    (433, Token (QVARID _)) -> Just (Reduce 1 203)
    (433, Token (QVARSYM _)) -> Just (Reduce 1 203)
    (433, Token (BACKQUOTE _)) -> Just (Reduce 1 203)
    (433, Token (QCONSYM _)) -> Just (Reduce 1 203)
    (434, Token (BACKQUOTE _)) -> Just (Shift 438)
    (435, Token (BACKQUOTE _)) -> Just (Shift 439)
    (436, Token (BACKQUOTE _)) -> Just (Shift 440)
    (437, Token (RBRACE _)) -> Just (Reduce 1 212)
    (437, Token (LPAREN _)) -> Just (Reduce 1 212)
    (437, Token (COMMA _)) -> Just (Reduce 1 212)
    (437, Token (SEMICOLON _)) -> Just (Reduce 1 212)
    (437, Token (MINUS _)) -> Just (Reduce 1 212)
    (437, Token (QCONID _)) -> Just (Reduce 1 212)
    (437, Token (EXPORT _)) -> Just (Reduce 1 212)
    (437, Token (AS _)) -> Just (Reduce 1 212)
    (437, Token (QVARID _)) -> Just (Reduce 1 212)
    (437, Token (QVARSYM _)) -> Just (Reduce 1 212)
    (437, Token (BACKQUOTE _)) -> Just (Reduce 1 212)
    (437, Token (QCONSYM _)) -> Just (Reduce 1 212)
    (438, Token (RBRACE _)) -> Just (Reduce 3 214)
    (438, Token (LPAREN _)) -> Just (Reduce 3 214)
    (438, Token (COMMA _)) -> Just (Reduce 3 214)
    (438, Token (SEMICOLON _)) -> Just (Reduce 3 214)
    (438, Token (MINUS _)) -> Just (Reduce 3 214)
    (438, Token (QCONID _)) -> Just (Reduce 3 214)
    (438, Token (EXPORT _)) -> Just (Reduce 3 214)
    (438, Token (AS _)) -> Just (Reduce 3 214)
    (438, Token (QVARID _)) -> Just (Reduce 3 214)
    (438, Token (QVARSYM _)) -> Just (Reduce 3 214)
    (438, Token (BACKQUOTE _)) -> Just (Reduce 3 214)
    (438, Token (QCONSYM _)) -> Just (Reduce 3 214)
    (439, Token (RBRACE _)) -> Just (Reduce 3 213)
    (439, Token (LPAREN _)) -> Just (Reduce 3 213)
    (439, Token (COMMA _)) -> Just (Reduce 3 213)
    (439, Token (SEMICOLON _)) -> Just (Reduce 3 213)
    (439, Token (MINUS _)) -> Just (Reduce 3 213)
    (439, Token (QCONID _)) -> Just (Reduce 3 213)
    (439, Token (EXPORT _)) -> Just (Reduce 3 213)
    (439, Token (AS _)) -> Just (Reduce 3 213)
    (439, Token (QVARID _)) -> Just (Reduce 3 213)
    (439, Token (QVARSYM _)) -> Just (Reduce 3 213)
    (439, Token (BACKQUOTE _)) -> Just (Reduce 3 213)
    (439, Token (QCONSYM _)) -> Just (Reduce 3 213)
    (440, Token (RBRACE _)) -> Just (Reduce 3 215)
    (440, Token (LPAREN _)) -> Just (Reduce 3 215)
    (440, Token (COMMA _)) -> Just (Reduce 3 215)
    (440, Token (SEMICOLON _)) -> Just (Reduce 3 215)
    (440, Token (MINUS _)) -> Just (Reduce 3 215)
    (440, Token (QCONID _)) -> Just (Reduce 3 215)
    (440, Token (EXPORT _)) -> Just (Reduce 3 215)
    (440, Token (AS _)) -> Just (Reduce 3 215)
    (440, Token (QVARID _)) -> Just (Reduce 3 215)
    (440, Token (QVARSYM _)) -> Just (Reduce 3 215)
    (440, Token (BACKQUOTE _)) -> Just (Reduce 3 215)
    (440, Token (QCONSYM _)) -> Just (Reduce 3 215)
    (_, _) -> Nothing
